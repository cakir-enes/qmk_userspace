 ...
 */
[_QWERTY] = LAYOUT(
    KC_TAB,              KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,                              KC_U,    KC_I,    KC_O,       KC_P,    KC_P,    KC_R,
    LT(_NUMPAD, KC_ESC), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                              KC_J,    KC_K,    KC_L,       KC_SCLN,  KC_QUOT, KC_ENT,
    LSFT_T(KC_ESC),     KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,   KC_MS_BTN1, KC_MS_BTN1,    KC_M,    KC_LT,   KC_COMMA,   KC_DOT,  KC_RSFT, RSFT_T(KC_ENT),
    LT(_SODA, KC_GRV),   KC_LCTL, KC_LCTL, KC_LALT, KC_LGUI, KC_SPC, BALL_SCR,   KC_MS_BTN2,    KC_RGUI, KC_RALT, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT
),
